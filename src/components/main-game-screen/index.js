			...
			<View style={{ flex: 1 }}>
				...
				<View style={style.container3}>
					...
					<View style={style.iconRow}>
						<CareIcon name="cutlery" type="font-awesome" onPress={() => this.props.onPress('feed')} />
						<CareIcon name="soccer-ball-o" type="font-awesome" onPress={() => this.props.onPress('play')} />
						<CareIcon name="bed" type="font-awesome" onPress={() => this.props.onPress('bedTime')} />
					</View>

					{/* Row 2 */}
					<View style={style.iconRow}>
						<CareIcon name="chat" type="entypo" onPress={() => this.props.onPress('socialise')} />
						<CareIcon
							name="emoticon-poop"
